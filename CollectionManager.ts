export const abi = [
  ...
  { inputs: [], name: 'acceptedToken', outputs: [{ internalType: 'contract IERC20', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  {
  ...
  { inputs: [], name: 'pricePerItem', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'rarities', outputs: [{ internalType: 'contract IRarities', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
...
export const address = '0x9d32aac179153a991e832550d9f96441ea27763a'
